...
class Node :
    ...
    def moveLeft(self):
        ...
        newNode = Node(newPuzzle,self.depth + 1, self.solution + 'L')
        return newNode
    ...
    def moveRight(self):
            ...
            newPuzzle[self.YZero][self.XZero + 1] = 0
            newPuzzle[self.YZero][self.XZero] = buffer
            newNode = Node(newPuzzle,self.depth + 1,self.solution + 'R')
            return newNode
    ...
    def moveUp(self):
            ...
            newPuzzle[self.YZero][self.XZero] = buffer
            newNode = Node(newPuzzle,self.depth + 1,self.solution + 'U')
            return newNode
    ...
    def moveDown(self):
            ...
            newPuzzle[self.YZero+1][self.XZero] = 0
            newPuzzle[self.YZero][self.XZero] = buffer
            newNode = Node(newPuzzle,self.depth + 1,self.solution + 'D')
            return newNode
